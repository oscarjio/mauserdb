...
### Nasta (session #402+) — BEKRAFTADE BUGGAR FRAN AGAREN (2026-04-26/29):
...
**Fixade i session #403 (2026-04-29):**
- DagligBriefingController::calcOeeForDay ibc_count-fix: morgonrapport visade 0 IBC (FIXAT, commit d32c29d0)
- StatistikDashboardController::getDaySummary ibc_count-fix: statistik visade 124 IBC (FIXAT, commit d32c29d0)
