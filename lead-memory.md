...
- Statistik dashboard frontend — integrera manads/kvartalsjamforelser
- Operatorsbonus — detaljvy per operator (drilldown)
- Skiftrapport — granska och forbattra UX
- Driftstopp-analys — forbattra timeline UX och filter
