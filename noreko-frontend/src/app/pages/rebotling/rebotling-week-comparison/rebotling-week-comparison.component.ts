...
@Component({
  standalone: true,
  selector: 'app-rebotling-week-comparison',
  templateUrl: './rebotling-week-comparison.component.html',
  imports: [CommonModule]
})
export class RebotlingWeekComparisonComponent implements OnInit, OnDestroy {
  weekComparisonLoaded = false;
  weekComparisonLoading = false;
