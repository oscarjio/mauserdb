...
@Component({
  ...
  template: `
    ...
    <!-- Felmeddelande -->
    <div *ngIf="!serviceLoading && serviceLoadError" class="text-center py-4" style="color:#fc8181;" role="alert">
      ...
      <div class="stats-table-wrap" *ngIf="serviceIntervals.length > 0">
        ...
        <div class="table-responsive">
          <table class="table table-dark table-stats mb-0">
            ...
            <tbody>
              <tr *ngFor="let si of serviceIntervals; trackBy: trackById">
                ...
                <td class="text-end">
                  <div class="d-flex gap-1 justify-content-end">
                    <button class="btn btn-sm btn-action btn-service-reset" (click)="resetServiceCounter(si)"
                            title="Registrera utförd service" aria-label="Registrera utford service">
                      <i class="fas fa-check-circle"></i>
                    </button>
                    <button class="btn btn-sm btn-action btn-edit" (click)="openServiceEditForm(si)"
                            title="Redigera intervall" aria-label="Redigera intervall">
