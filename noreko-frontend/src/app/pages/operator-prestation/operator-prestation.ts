...
export class OperatorPrestationPage implements OnInit {
  ...
  readonly tvattlinjeGroups: { label: string; tools: ToolCard[] }[] = [
    {
      label: 'Ranking & Analys',
      tools: [
        { title: 'IBC/h Ranking', desc: 'Operatörer rankade på IBC/h vs teamsnitt — Elite/Solid/Utveckling/Behöver stöd', route: '/tvattlinje/operator-ranking', icon: 'fas fa-medal', color: '#68d391' },
        { title: 'Bemanning-optimerare', desc: 'Välj tillgängliga operatörer — systemet föreslår bästa placering per position och visar historiska toppteam', route: '/bemanning-optimerare', icon: 'fas fa-users-cog', color: '#63b3ed' },
      ]
    },
  ];
  ...
  readonly rebotlingGroups: { label: string; tools: ToolCard[] }[] = [
    ...
    },
    {
      ...
      tools: [
        ...
        { title: 'Scenarioanalys', desc: 'Vad-händer-om-kalkylator — beräkna hur mycket extra IBC tre operativa förbättringar ger: sänk kassationen, minska stopptiden, eller lyft underprestörerna. Realtidsberäkning med sliders + sammanfattad potential.', route: '/rebotling/scenarioanalys', icon: 'fas fa-flask', color: '#76e4f7' },
      ]
    },
  ];
}
