...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'tvattlinje/operator-ranking',     canActivate: [adminGuard], loadComponent: () => import('./pages/tvattlinje-operator-ranking/tvattlinje-operator-ranking').then(m => m.TvattlinjeOperatorRankingPage) },
      { path: 'tvattlinje/operator-topplista',   canActivate: [adminGuard], loadComponent: () => import('./pages/tvattlinje-operator-ranking/tvattlinje-operator-ranking').then(m => m.TvattlinjeOperatorRankingPage) },
      { path: 'tvattlinje/operator-poang',       canActivate: [adminGuard], loadComponent: () => import('./pages/tvattlinje-operator-ranking/tvattlinje-operator-ranking').then(m => m.TvattlinjeOperatorRankingPage) },
