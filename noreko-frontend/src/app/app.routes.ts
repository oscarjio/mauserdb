...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'rebotling/operator-ranking', canActivate: [authGuard], data: { line: 'rebotling' }, loadComponent: () => import('./pages/operator-ranking/operator-ranking.component').then(m => m.OperatorRankingPage) },
      ...
      { path: 'rebotling/operator-prestation', canActivate: [adminGuard], data: { line: 'rebotling' }, loadComponent: () => import('./pages/operator-prestation/operator-prestation').then(m => m.OperatorPrestationPage) },
      ...
      { path: 'rebotling/dagsplanering', canActivate: [adminGuard], loadComponent: () => import('./pages/dagsplanering/dagsplanering').then(m => m.DagsplaneringPage) },
      { path: 'rebotling/veckoplanering', canActivate: [adminGuard], loadComponent: () => import('./pages/veckoplanering/veckoplanering').then(m => m.VeckoplaneringPage) },
      { path: 'rebotling/scenarioanalys', canActivate: [adminGuard], loadComponent: () => import('./pages/scenarioanalys/scenarioanalys').then(m => m.ScenarioanalysPage) },
      ...
      { path: 'tvattlinje/operator-ranking',   canActivate: [adminGuard], data: { line: 'tvattlinje' }, loadComponent: () => import('./pages/operator-scores/operator-scores').then(m => m.OperatorScoresPage) },
      ...
      { path: 'tvattlinje/operator-topplista', redirectTo: 'tvattlinje/operator-ranking', pathMatch: 'full' },
      { path: 'tvattlinje/operator-poang',     redirectTo: 'tvattlinje/operator-ranking', pathMatch: 'full' },
