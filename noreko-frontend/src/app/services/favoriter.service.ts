...
export const AVAILABLE_PAGES: AvailablePage[] = [
  ...
  { route: '/rebotling/operator-jamforelse', label: 'Operatörsjämförelse', icon: 'fas fa-users', color: '#4299e1' },
  { route: '/rebotling/produktionseffektivitet', label: 'Produktionseffektivitet/h', icon: 'fas fa-clock', color: '#68d391' },
  { route: '/oversikt', label: 'VD-översikt', icon: 'fas fa-tachometer-alt', color: '#63b3ed' },
  { route: '/rapporter/manad', label: 'Månadsrapport', icon: 'fas fa-calendar-alt', color: '#4299e1' },
  { route: '/rapporter/vecka', label: 'Veckorapport', icon: 'fas fa-calendar-week', color: '#68d391' },
  { route: '/tvattlinje/live', label: 'Tvättlinje Live', icon: 'fas fa-broadcast-tower', color: '#4fd1c5' },
