...
- [PÅGÅR] **Rebotling OEE-jämförelse per vecka** — jämför OEE vecka-för-vecka med trendpilar, identifiera förbättring/försämring
- [PÅGÅR] **Maskin-drifttid heatmap** — visuell heatmap per timme/dag som visar när maskiner kör vs står stilla
- [ ] **Rebotling skiftrapport-sammanställning** — automatisk daglig rapport per skift: produktion, kassation, OEE, stopp — mejlas eller visas vid skiftbyte
- [ ] **Produktionsmål-dashboard** — sätt vecko/månadsmål, visa progress i realtid med cirkeldiagram + prognos "i nuvarande takt når ni målet [dag]"
