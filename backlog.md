...
### Nasta (session #348):
- [ ] **Granska EnergiController+KvalitetController+ForbrukningController** — A: SQL+endpoints, B: UI
- [ ] **Granska OperatorController djupare** — A: alla endpoints+edge cases, B: operator-UI
- [ ] **Granska alla admin-sidor** — A: admin-endpoints, B: admin-UI UX+validering
